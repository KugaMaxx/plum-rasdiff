...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=int,
        help=(
            "Dimension of the index vectors. This should be greater than or equal to the flattened sensor reading size. "
            "For example, with 8 sensors and 128 historical time steps, index_dim should be at least 8 × 128 = 1024."
        ),
    )
